...
class Block extends DataObject
{
    ...
    public function createStringAsHTML($html)
    {
        ...
        $casted = \SilverStripe\ORM\FieldType\DBHTMLText::create();
    ...
    public static function getCMSThumbnail()
    {
        ...
        $output = \SilverStripe\ORM\FieldType\DBHTMLText::create();
    ...
    public function getCMSFields()
    {
        ...
        $fields->addFieldsToTab('Root.Help', new \SilverStripe\Forms\LiteralField('help', $help_content));
...
CSS
    ...
    {
        return \SilverStripe\Security\Permission::check('ADMIN') || \SilverStripe\Security\Permission::check('CMS_ACCESS_BlockAdmin') || \SilverStripe\Security\Permission::check('CMS_ACCESS_LeftAndMain');
    }
    ...
    function forTemplate() {
        ...
        return $this->renderWith(array("Blocks".DIRECTORY_SEPARATOR.$this->ClassName,'SilverStripe_Blocks\Layout\Block')); // Fall back to Block if selected does not exist
    }
